...
<<<<<<< HEAD
  (setq user-full-name "Tuna"
    user-mail-address "tuna@sodamelon.com")
=======
  (setq user-full-name "Tuna"
    user-mail-address "tuna@sodamelon.com")
...
#+BEGIN_SRC emacs-lisp
  ...
  (when (system-is-mac)
<<<<<<< HEAD
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tuna/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tuna/bin" "/profile/bin" "/Users/tuna/.npm-packages/bin" "/Users/tuna/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
=======
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tuna/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tuna/bin" "/profile/bin" "/Users/tuna/.npm-packages/bin" "/Users/tuna/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
>>>>>>> 83fa02a (Set up mac initially)
